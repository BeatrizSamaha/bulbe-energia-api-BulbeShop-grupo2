...
inserirProduto.run({ title: 'Garrafa de água Tupperware',   description: 'Garrafa de água reutilizável, ideal para manter a hidratação.', price: 53.00, price_was: 299.00, promo: '7% OFF', category: 'Conforto',            stock: 100, image: 'garrafa-tupperware.jpg',             rating: 4.3, variations: JSON.stringify(['500ml', '750ml', '1L']),         loja_id: null, destaque: 0 });
